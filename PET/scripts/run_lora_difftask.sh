...
# layer=68
# layer=6
# function=layer${layer}_selfattn_lorarank${lora_rank}_trainbtz${train_btz}
# function=layer${layer}_fnn_lorarank${lora_rank}_trainbtz${train_btz}
