...
class Model(PushToHubFriendlyModel):
    def __init__(self, args):
        ...
        print(f"prefix-tuning sequence length is {self.preseqlen}.", flush=True)
        print("adapter is used.", flush=True)
        ...
        self.config.adapter_reduction_size = self.args.adapter_reduction_size
