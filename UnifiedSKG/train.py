...
def main() -> None:
    ...
    # print(f'Arguments: {args.__iter__()}', flush=True)
    print(f'{args.bert}', flush=True)
    ...
    if not args.arg_paths:
        ...
        for task, arg_path in args.arg_paths:
            ...
            print('task_args.bert.location:', task_args.bert.location, flush=True)
    ...
    print('Trainer build successfully.', flush=True)
