...
exp+="${task_type}-task_${dataset_config}_ngpu${ngpu}_model_${model_name}_run$runid"
...
skg_cfg=Salesforce/T5_base_finetune_spider_with_cell_value.cfg #spider
# skg_cfg=Salesforce/T5_base_finetune_${dataset}.cfg #general
