...
try:
    ...
    # nltk.data.path.append('/data/nt12_ssd_gluster/public/yingxiu/DATA/nltk')
...
def main():
    ...
    logger.info(f"Tuning parameters {tune_args}")
    ...
    if data_args.dataset_name is not None:
        ...
        # cccache = '/data/nt12_ssd_gluster/public/yingxiu/DATA/PET/xsumdata'
        # datasets = load_dataset(data_args.dataset_name, data_args.dataset_config_name, cache_dir=cccache)
    else:
        data_files = {}
        ...
        # datasets = load_dataset(extension, data_files=data_files, cache_dir=cccache)
    ...
    # metric = load_metric("rouge", cache_dir="/data/nt12_ssd_gluster/public/yingxiu/DATA/PET/rouge")
    metric = evaluate.load('rouge')
    # metric = load_metric("/data/nt12_ssd_gluster/public/yingxiu/CODE/UPET/utils/rouge.py")
